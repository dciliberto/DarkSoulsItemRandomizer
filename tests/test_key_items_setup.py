...
class list_of_five_true(key_placed_unit_tests):
    def runTest(self):
        self.assertTrue(self.key_placed_instance("lordvessel", \
            {
                "blighttown_key":"blighttown",
                "lordvessel":"blighttown",
                "mystery_key":"new_londo_ruins",
                "large_ember":"firelink_shrine",
                "orange_charred_ring":"lost_izalith"
            }))
